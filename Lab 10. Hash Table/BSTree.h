...
class BSTree                                     // KeyType : key field
{
  ...
  protected:
    ...
    int getHightHelper(BSTreeNode* p) const;
    void writeLessThanHelper(BSTreeNode* tempNode, const KeyType& searchKey) const;
    void writeKeysHelper(const BSTreeNode* tempNode) const;
    void clearHelper(BSTreeNode* node);
    void copyTreeHelper(BSTreeNode* t1, BSTreeNode* t2);
